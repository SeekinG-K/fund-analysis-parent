...
public class InvestHttpRequestTemplateServiceImpl implements InvestHttpRequestTemplateService {
    ...
    public <T> T getRequestParamData(String uri, Class<T> clazz) {
        URI uriInfo = null;
        try {
            uriInfo = new URI("http://fund.eastmoney.com/data/rankhandler.aspx");
            ...
            ResponseEntity<T> responseEntity = restTemplate.exchange(uriInfo, HttpMethod.POST, requestEntity, clazz);
